...
class CreateSubgraph:
    ...
    def similar_predicates(self, _predicates, _return_indices=False, _k=5):
        """
            This was used as a similarity function to reduce search space. For the purpose of this tutorial
            this has been stripped down and it assigns the same score for all the predicate with respect to question.
        ...
        for i in range(len(_predicates)):
            ...
            similarity_arr[i] = np.float64(1.0)
    ...
    def subgraph(self,_entities,_relations,_use_blacklist=True,_qald=False):
        '''
